...
// ========================== 环境变量配置 ==========================
const UUID = process.env.UUID || '50a35978-af84-4244-b03b-3e0c5d801491';
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';
const NEZHA_KEY = process.env.NEZHA_KEY || '';             
const DOMAIN = process.env.DOMAIN || 'vercelcf.pages.dev';    
const AUTO_ACCESS = process.env.AUTO_ACCESS || false;      
const SUB_PATH = process.env.SUB_PATH || '50a35978-af84-4244-b03b-3e0c5d801491';           
